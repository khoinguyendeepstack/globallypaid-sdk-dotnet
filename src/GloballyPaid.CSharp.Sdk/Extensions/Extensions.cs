...
namespace GloballyPaid
{
    public static class Extensions
    {
        ...
        public static string CreateHMAC(this object obj, string sharedSecret, string appId)
        {
            ...
            {
                throw new GloballyPaidException("Your Globally Paid Shared Secret is not configured");
            }

            if (string.IsNullOrEmpty(appId))
            {
                throw new GloballyPaidException("Your Globally Paid APP ID is not configured");
            }
        ...
        {
            GloballyPaidConfiguration.Setup(publishableApiKey, sharedSecret, appId, useSandbox, requestTimeoutSeconds);
